...
public class MainTensors {
    ...
    public static final Expression[] HATKs = new Expression[]{HATK_1, HATK_2, HATK_3, HATK_4};
    ...
    public static final Expression[] ALL = new Expression[]{Flat, WR, SR, SSR, FF, FR, RR, DELTA_1, DELTA_2, DELTA_3, DELTA_4, HATK_1, HATK_2, HATK_3, HATK_4};
