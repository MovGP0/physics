...
public class OneLoopCountertermsTest {
    ...
    */
    ...
    public void testGravityGhosts0() {
        ...
        Tensor expected = Expand.expand(Tensors.parse("7/30*R^{\\mu \\nu }*R_{\\mu \\nu }+17/60*Power[R, 2]"));
        TAssert.assertEquals(Expand.expand(A), expected);
    }
    ...
    */
    ...
    public void testVectorField() {
        ...
        TAssert.assertEquals(Expand.expand(actual), expected);


        //simplified result
        actual = Factor.factor(A);
    ...
    public void testGravityGhosts() {
        ...
        TAssert.assertEquals(Factor.factor(A), expected);
    }
    ...
    */
    ...
    public void testSquaredVectorField() {
        ...
        Tensor A = action.getCounterterms().get(1);
        Tensor actual = Tensors.parseExpression("P^\\mu_\\mu = P").transform(A);
        actual = Expand.expand(Together.together(Expand.expand(Together.together(actual))));
